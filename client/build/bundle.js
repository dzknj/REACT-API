...
/***/ function(module, exports, __webpack_require__) {
	      ...
	      this.state.cities.map(city => {
	        return React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'button',
	              { onClick: this.editCity(city._id) },
	              ' EDIT '
	            ),
	            React.createElement(
	              'button',
	              { onClick: this.removeCity(city._id) },
	              ' DELETE '
	            )
	          ),
	          React.createElement(
	            'form',
	            { id: city._id, className: city.editing ? null : 'hidden', onSubmit: this.saveCity },
	            React.createElement('input', { type: 'text', name: 'city-name', placeholder: 'City Name', defaultValue: city.name }),
	            React.createElement('input', { type: 'text', name: 'city-crimeLevel', placeholder: 'Crime-Level', defaultValue: city.crimeLevel }),
	            React.createElement(
	              'button',
	              { type: 'submit' },
	              'SAVE CITY'
	...
	var NewCity = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement('input', { type: 'text', name: 'city-name', placeholder: 'City Name' }),
	      React.createElement('input', { type: 'text', name: 'city-crimeLevel', placeholder: 'CrimeLevel' }),
	      React.createElement(
	        'button',
	        { type: 'submit' },
	        'CREATE CITY'
	...
	ReactDOM.render(React.createElement(GetCities, null), document.getElementById('city-holder'));
	ReactDOM.render(React.createElement(NewCity, null), document.getElementById('newcity'));
